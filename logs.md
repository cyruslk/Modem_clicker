...
This fact that internet is a messy, physical, odd, weird, delayed, irregular (and so on) network (or should I say infrastructure, which relates in my sense to a  much more tangible and concrete entity) highly interests me. While working on a previous game (the [MODEMGUESSINGGAME](https://github.com/cyruslk/MODEMGUESSINGGAME)), I read two books that highly influenced my thoughts and helped me reframe my ideas.
...
This consequently reveals that internet has a materiality, and that (part of) its materiality is tangible, geographically located; and that because internet was crafted this way, it enables all sorts of practices and counter-practices ([sabotages](https://globalnews.ca/news/4115233/russia-sabotage-undersea-fiber-optic-cables/), [resistance](https://www.theguardian.com/technology/2013/mar/28/egypt-undersea-cable-arrests) and [so on](https://www.theguardian.com/world/2011/apr/06/georgian-woman-cuts-web-access)).

- [x] Internet's materiality vs ISP's marketing strategies?

However, what struck me the most through this book is the general position ISP (Internet Service Providers) defend regarding internet's infrastructure, following the idea that if "**the public doesn’t know about the importance of undersea cables, they will not think to contest or disrupt them.**" (Starosielski, 2015)
